...
import static es.uvigo.esei.dai.hybridserver.utils.TestUtils.assertEqualsIgnoreSpacesAndCase;
...
extends MultipleServersTestCase {
	...
	protected void testMultipleGets(
		...
		for (int i = 0; i < xmls.length; i++) {
			...
			assertEqualsIgnoreSpacesAndCase(expectedContent.toLowerCase(), content.toLowerCase());
		}
	}
