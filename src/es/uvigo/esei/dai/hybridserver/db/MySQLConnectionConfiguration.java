...
import es.uvigo.esei.dai.hybridserver.db.AbstractConnectionConfiguration;
import es.uvigo.esei.dai.hybridserver.db.ConnectionConfiguration;

public class MySQLConnectionConfiguration extends
		AbstractConnectionConfiguration implements ConnectionConfiguration {
	...
	public MySQLConnectionConfiguration(String userName, String password,
	...
	public void setPortNumber(int portNumber) throws IllegalArgumentException {
		if (portNumber > 65535)
			throw new IllegalAccessError(
					"Port number must be in range [0, 65535] or negative for disable");
